...
function FeatureItem({item, iconSvg}) {
  return (
    <div>
      {iconSvg && (
        <div class="mx-auto flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-primary-100 lg:h-14 lg:w-14 dark:bg-primary-900 text-primary-600 dark:text-primary-300">
